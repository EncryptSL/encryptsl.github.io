...
<svelte:head>
    ...
    <link rel="canonical" href="https://mojweb.cz/" />
    <meta property="og:title" content="EncryptSL - Linktree" />
</svelte:head>

<container
    class="flex items-center justify-center font-inter min-h-screen p-4"
>
    <div
        class="linktree-card glass bg-slate-800/60 rounded-xl shadow-lg p-6 md:p-8 text-center text-white w-full max-w-md"
    >
        <img
