      ...
      >
        ...
        <p class="pt-2 text-center">
          ...
          primarily focusing on the <span
            class="bg-blue-200 text-black px-1 rounded-sm">Nette Framework</span
          >,
        ...
        <div class="max-w-sm rounded shadow-lg p-3 mx-auto">
          <h2 class="text-1xl font-semibold text-center">Spooken Languages</h2>
        ...
        <div class="mt-4 w-full border-t border-white/20 pt-4">
          ...
          >
            <div class="relative group inline-flex justify-center items-center">
              ...
              >
                <SquareLibrary class="h-5 w-5 text-white" />
              </a>
              <div
            ...
            <div class="relative group inline-flex justify-center items-center">
              ...
              >
                ...
                >
                  ...
                  />
                  <path
                    d="M10 12L7 9H4V6H7L10 9L13 6H16V9H13L10 12ZM14 15L17 12H20V15H17L14 18L11 15H8V12H11L14 15Z"
                    fill="#fff"
                  />
                  <path
                    d="M10 12L7 9H4V6H7L10 9L13 6H16V9H13L10 12ZM14 15L17 12H20V15H17L14 18L11 15H8V12H11L14 15Z"
      ...
      <div class="columns-1 sm:columns-2 md:columns-2 gap-4 w-full">
        ...
        <div class="bg-white/10 p-4 rounded-lg break-inside-avoid mb-4">
          ...
          <div class="flex flex-wrap gap-2">
            ...
            <span class="bg-purple-200 text-black px-1 rounded-sm">Kotlin</span>
            <span class="bg-green-200 text-black px-1 rounded-sm">Python</span>
            <span class="bg-red-200 text-black px-1 rounded-sm">JavaScript</span
            >
